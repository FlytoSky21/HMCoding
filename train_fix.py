...
def parse_args(argv):
    ...
    parser.add_argument("--save_path",
                        default='/home/adminroot/taofei/DCC2023fuxian/result/fix_base/flicker/ReduceLROnPlateau/stf_encNoBias_dec_allconv4',
...
def main(argv):
    ...
    # 固定基本网络:
    net = freeze_model(model=net, to_freeze_dict=pretrained_dict)
